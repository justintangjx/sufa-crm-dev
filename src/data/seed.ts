...
export function buildSeed(): MockData {
  ...
  const npsAssignments: CampaignNpsAssignment[] = [
    {
      id: "npsa-u24-post-alice",
      survey_id: "nps-u24-post",
      rater_kind: "player",
      athlete_id: "a-alice",
